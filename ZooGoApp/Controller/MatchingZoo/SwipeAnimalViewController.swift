...
class SwipeAnimalViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if passedSetLabel != "" {
            ...
            titleLabel.text = passedSetLabel
    ...
    zooNameA.font = UIFont(name: "HiraKakuProN-W6", size: 16)
    zooNameB.font = UIFont(name: "HiraKakuProN-W6", size: 16)
    zooNameC.font = UIFont(name: "HiraKakuProN-W6", size: 16)
    zooNameD.font = UIFont(name: "HiraKakuProN-W6", size: 16)
    zooNameE.font = UIFont(name: "HiraKakuProN-W6", size: 16)
